// The recurrence-expansion half of the old api/calendar-events.js, kept for
// the vite dev/e2e calendar fixture after the API moved to Cookie-Worker's
// cookie-web-calendar (which holds the canonical copy in src/recurrence.js —
